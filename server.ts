...
async function startServer() {
  ...
  app.get('/api/auth/check-access/:requiredRole', authenticateToken, authController.checkRoleAccess);
  app.put('/api/auth/update-role', authenticateToken, authController.updateRole);
